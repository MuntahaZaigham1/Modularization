...
public class LocationActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void onConnected(@Nullable Bundle bundle) {
        ...
        if (location != null) {
         ...
         //   LocTrackingRepo loc = new LocTrackingRepo(getApplicationContext());

        //  loc.insertTask(location.getLatitude(),location.getLongitude(), "9.10.2019", "9:10", 1);
        }
    ...
    public void onLocationChanged(Location location) {
        ...
        if (location.distanceTo(currlocation) > 150 && (location.distanceTo(mLastLocation) <= 500)) {
            ...
            locTrackingRepo.insertTask(location.getLatitude(),location.getLongitude(),currentDate,currentTime,0);
        }
